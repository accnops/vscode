...
import type { SessionAddedParams, SessionRemovedParams, SessionSummaryChangedParams, DownloadProgressParams, AuthRequiredParams } from './protocol/notifications.js';
...
export type ProtocolNotification =
	...
	| ({ type: 'root/downloadProgress' } & DownloadProgressParams)
